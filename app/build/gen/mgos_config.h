 ...
 * Command: /data/fwbuild-volumes/latest/apps/app/esp32/build_contexts/build_ctx_097374481/deps/modules/mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/latest/apps/app/esp32/build_contexts/build_ctx_097374481/build/gen/ /data/fwbuild-volumes/latest/apps/app/esp32/build_contexts/build_ctx_097374481/deps/modules/mongoose-os/src/mgos_debug_udp_config.yaml /data/fwbuild-volumes/latest/apps/app/esp32/build_contexts/build_ctx_097374481/deps/modules/mongoose-os/platforms/esp32/src/esp32_sys_config.yaml /data/fwbuild-volumes/latest/apps/app/esp32/build_contexts/build_ctx_097374481/build/gen/mos_conf_schema.yml
 */
...
void mgos_config_set_wifi_ap_bandwidth_20mhz(struct mgos_config *cfg, int         val);
...
void mgos_config_set_wifi_sta_ps_mode(struct mgos_config *cfg, int         val);
void mgos_config_set_wifi_sta_all_chan_scan(struct mgos_config *cfg, int         val);
...
void mgos_config_set_apmode(struct mgos_config *cfg, int         val);
/* }}} */
...
static inline void mgos_sys_config_set_wifi_ap_bandwidth_20mhz(int         val) { mgos_config_set_wifi_ap_bandwidth_20mhz(&mgos_sys_config, val); }
...
static inline void mgos_sys_config_set_wifi_sta_ps_mode(int         val) { mgos_config_set_wifi_sta_ps_mode(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_wifi_sta_all_chan_scan(int         val) { mgos_config_set_wifi_sta_all_chan_scan(&mgos_sys_config, val); }
...
static inline void mgos_sys_config_set_apmode(int         val) { mgos_config_set_apmode(&mgos_sys_config, val); }
